...
var app = {
  ...
  function mouseDown0(e) {
      var down = true;
      if (down === true ){
        firebase.database().ref('talk1').set({buttonClicked: 1});
  ...
  function mouseUp0() {
    var down = false;
    if (down === false ){
        firebase.database().ref('talk1').set({buttonClicked: 0});
    }
  }
    function mouseDown(e) {
        var down = true;
        if (down === true ){
          firebase.database().ref('talk2').set({buttonClicked: 1});
    ...
    function mouseUp() {
      var down = false;
      if (down === false ){
          firebase.database().ref('talk2').set({buttonClicked: 0});
      }
    }
    ...
    function mouseDown3(e) {
        var down = true;
        if (down === true ){
          firebase.database().ref('talk3').set({buttonClicked: 1});
        }
        e.preventDefault();
        return false;
    }
    ...
    function mouseUp3() {
      var down = false;
      if (down === false ){
          firebase.database().ref('talk3').set({buttonClicked: 0});
      }
    }
    ...
    function mouseDown4(e) {
        var down = true;
        if (down === true ){
          firebase.database().ref('talk4').set({buttonClicked: 1});
        }
        e.preventDefault();
        return false;
    }
    ...
    function mouseUp4() {
      var down = false;
      if (down === false ){
          firebase.database().ref('talk4').set({buttonClicked: 0});
      }
    }
